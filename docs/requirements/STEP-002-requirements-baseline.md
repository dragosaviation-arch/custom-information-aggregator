...
- 11 user needs;
- 7 use cases;
- 62 baselined user requirements;
- complete 62/62 requirement traceability;
- 6 resolved open questions;
- 12 recorded requirements decisions.

Primary baseline users are Planning personnel, including Document Control and Quotations.

## Requirement Coverage

The 62 requirements comprise:
...
The baseline covers source selection, XML processing, nested archives, information discovery and extraction, cross-source structured information indexing/query/filtering, reusable profiles, preview, configurable Excel export field inclusion and ordering, user-controlled processing cancellation, progress and error handling, reliability, local Windows operation and installable delivery.
